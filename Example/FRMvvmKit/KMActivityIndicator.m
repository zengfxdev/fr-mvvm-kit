...
- (void)stopAnimating
{
    ...
    _stepNumber = KMActivityIndicatorStepNone;
    _firstDot.frame = _fourthPoint;
    _secondDot.frame = _firstPoint;
    _thirdDot.frame = _thirdPoint;
}
...
-(void)setColor:(UIColor *)color{
    ...
    _firstDot.backgroundColor = color.CGColor;
    _secondDot.backgroundColor = color.CGColor;
    _thirdDot.backgroundColor = color.CGColor;
}
